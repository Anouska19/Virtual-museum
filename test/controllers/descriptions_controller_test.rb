...
class DescriptionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create description" do
    assert_difference('Description.count') do
      post descriptions_url, params: { description: { l_histoire_de_l_oeuvre: @description.l_histoire_de_l_oeuvre, technique_utilise: @description.technique_utilise } }
    end
  ...
  test "should update description" do
    patch description_url(@description), params: { description: { l_histoire_de_l_oeuvre: @description.l_histoire_de_l_oeuvre, technique_utilise: @description.technique_utilise } }
